...
function verTiempo() {
    ...
    if (ciudad == "") {
        ...
        mensaje.textContent = "Peticion Realizada";
...
function rellenarWidget(json){
    ...
    var max = parseInt(json.main.temp) - 273;
     var max = parseInt(json.main.temp_max) - 273;
    var min = parseInt(json.main.temp_min) - 273;
    var maxMin = "Max:"+max+"º - Min: "+min+"º";
 document.getElementById("maxMin").textContent =maxMin;
